...
if __name__ == '__main__':
    ...
    data, baseNouveauDD = projectionAgesCOUNT(data, PL_ME, frequence, TGH05, TGF05, tauxIntraAnnuel_RadtoPrest, tauxIntraAnnuel_RadtoDC, tauxIntraAnnuel_PresttoDC, tauxIntraAnnuel_CERtoPrest, tauxIntraAnnuel_CERtoDC, difference_age_DD, tauxNuptialite, tauxReversion, ageMinReversion=ageMinReversion, lissageTaux=True, utiliserTableExp=False)
